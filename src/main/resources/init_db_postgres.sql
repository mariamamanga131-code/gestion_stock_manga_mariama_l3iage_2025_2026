...
INSERT INTO utilisateurs (email, nom, mot_de_passe_hash, role, actif)
VALUES
('admin@gestionstock.com', 'Admin Principal', '$2a$12$wgOO0a6I30VNbrRCpK5PfOmI0SCHH0L8UcBKqbBFv2QqdQy0q2d0C', 'ADMIN', true),
('gestionnaire@gestionstock.com', 'Gestionnaire Test', '$2a$12$1nX49eATuNJTX2dINnuC4.ZbOQTpkJzjOjCAX0ZzIwrYG1.cz16uK', 'GESTIONNAIRE', true);                                                                                  ('Bureau en bois', 87000.0, 8, 2, 2, 2);